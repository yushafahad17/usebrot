...
GCAST_BLACKLIST = [
    ...
    -1001287188817,  # Kazu Support
    -1002058271197,  # Consterly Support
]
...
class Config(object):
    ...
    UPSTREAM_REPO_URL = getenv("UPSTREAM_REPO_URL", "https://github.com/yushafahad17/usebrot.git")
    ...
    # Default .alive name
    ALIVE_NAME = getenv("ALIVE_NAME", "Aethers-Userbot")
    ...
    ALIVE_LOGO = (getenv("ALIVE_LOGO")
                or "https://telegra.ph//file/4ee0d0108ebac618a59f1.jpg")
