...
from Uputt import CMD_HELP, OWNER_ID, bot
from Uputt.database.bot_blacklist import (
    add_user_to_bl,
    check_is_black_list,
    get_all_bl_users,
    rem_user_from_bl,
...
from Uputt.database.bot_pms import get_user_id
...
@uputt_cmd(pattern="(set|reset) pmbot(?: |$)(\\w*)")
