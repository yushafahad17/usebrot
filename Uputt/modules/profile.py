...
@uputt_cmd(pattern="name", allow_sudo=False)
...
@uputt_cmd(pattern="setpfp$", allow_sudo=False)
...
@uputt_cmd(pattern="setbio (.*)", allow_sudo=False)
...
@uputt_cmd(pattern="username (.*)", allow_sudo=False)
...
async def count(event):
    ...
    dialogs = await Uputt.get_dialogs(limit=None, ignore_migrated=True)
    for d in dialogs:
...
@uputt_cmd(pattern="delpfp", allow_sudo=False)
