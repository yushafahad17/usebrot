...
from Uputt.iamuput import uputt_cmd, eor, humanbytes, progress, run_cmd
from Uputt.iamuput.FastTelethon import download_file, upload_file

from . import cmd, var


@uputt_cmd(pattern="download(?: |$)(.*)")
