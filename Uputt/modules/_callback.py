...
@bot.on(events.CallbackQuery(data=b"inline_putt"))
...
async def close(event):
    ...
    await event.edit("**ᴍᴇɴᴜ ᴅɪᴛᴜᴛᴜᴘ**", file=logouputt, buttons=buttons)
