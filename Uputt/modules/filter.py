...
from Uputt.database.filters import add_filter, del_filter, get_all_filters, update_filter
from Uputt.events import uputt_cmd, register
...
@Uputt.on(uputt_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@Uputt.on(uputt_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@Uputt.on(uputt_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@Uputt.on(uputt_cmd(outgoing=True, pattern=r"filters$"))
