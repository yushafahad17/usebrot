...
from Uputt import Uputt, CMD_LIST



def uputt_cmd(pattern=None, command=None, **args):
...
def command(**args):
    ...
    def decorator(func):
        ...
        if allow_edited_updates:
            Uputt.add_event_handler(func, events.MessageEdited(**args))
        Uputt.add_event_handler(func, events.NewMessage(**args))
    ...
    def decorator(func):
        ...
        if Uputt:
            if not disable_edited:
                Uputt.add_event_handler(wrapper, events.MessageEdited(**args))
            Uputt.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
